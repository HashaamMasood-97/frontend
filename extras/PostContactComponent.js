...
export class PostContact extends Component {
  constructor(props) {
    super(props);
  ...
  onSubmit = () => {
    ...
    const product = {
      ...
      phone: this.state.quantity,
    };

    axios
      .post(ip + ":3700/gift/contact/post", product)
    ...
    return (
      <View>
        ...
        <View>
          ...
          <Button onPress={this.onSubmit} title="Learn More" color="#841584" />
        </View>
      </View>
    );
  }
